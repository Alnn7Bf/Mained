function ServiceCard({ image, icon, title, description }) {
  ...
  return (
    <div className="relative overflow-hidden rounded-global cursor-pointer">
      ...
      <div className="relative h-full flex flex-col gap-2 p-6 items-center bg-black/60 md:bg-light md:hover:bg-black/60 text-light md:text-black hover:text-light transition-colors duration-300">
