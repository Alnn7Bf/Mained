...
function Navbar() {
  ...
  return (
    <nav className={`z-20 flex fixed w-dvw ${isOpen? 'bg-white/80' : 'bg-white/40'} md:bg-white/40 justify-center flex-col md:flex-row text-black transition-all duration-500`} id="menu">
