  ...
  return (
    <>
      <section className="flex justify-center items-center bg-light px-4 pb-6" id="contact">
        <div className="w-full max-w-5xl bg-primary text-light rounded-global p-8 md:p-12 flex flex-col md:flex-row gap-12 md:gap-16">
          <div className="flex flex-col gap-8 flex-1 py-8">
            ...
            <div className="flex flex-row gap-2">
              ...
              <a href="https://www.instagram.com" target="_blank" rel="noopener noreferrer" className="p-2 cursor-pointer">
                <Instagram size={20}/>
              </a>
              <a href="https://www.x.com" target="_blank" rel="noopener noreferrer" className="p-2 cursor-pointer">
                <XTwitter size={20}/>
              </a>
              <a href="https://www.linkedin.com" target="_blank" rel="noopener noreferrer" className="p-2 cursor-pointer">
                <LinkedIn size={20}/>
              </a>
            </div>
          </div>
